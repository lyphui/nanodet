...
def parse_args():
    ...
    "/media/data1/hjh9_data/project_codes/nanodet/train_model_save/det001/screw/det001_0905_2/logs-2022-09-05-12-08-55/train_cfg.yml")
    parser.add_argument("--model", type=str, default=
    "/media/data1/hjh9_data/project_codes/nanodet/train_model_save/det001/screw/det001_0905_2/model_last.ckpt")
